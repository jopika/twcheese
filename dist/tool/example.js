/*!---------------------------------------------------------------------
 * Alerts something stupid depending on the player's id.
 * 
 ...
 *---------------------------------------------------------------------*/
/*! Tool setup compiled from /src/ToolSetup/example.js
 *---------------------------------------------------------------------*/
(function() {
    let toolId = 'example';
    ...
    if (!TwCheese.hasTool(toolId)) {
        ...
        // CONCATENATED MODULE: ./src/Models/Example.js
        ...
        // CONCATENATED MODULE: ./src/ToolSetup/example.js
