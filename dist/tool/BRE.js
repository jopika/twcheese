...
(function() {
    ...
    if (!TwCheese.hasTool(toolId)) {
        ...
        /* harmony import */ var _conf_ImageSrc_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
        ...
        initCss(`
            .twcheese-popup {
                ...
                border-image: url(${_conf_ImageSrc_js__WEBPACK_IMPORTED_MODULE_0__[/* ImageSrc */ "a"].popupBorder}) 19 19 19 19 repeat;
                left: 50%;
        ...
        /* harmony import */ var _src_Models_Debug_DebugProcess_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
        /* harmony import */ var _src_Models_Debug_Build_PhaseFactory_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
        /* harmony import */ var _src_Models_Debug_BugReporter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
        /* harmony import */ var _src_Models_Debug_PhaseReport_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
        ...
        /* harmony import */ var _src_Models_Debug_DebugEvents_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
        ...
        /* harmony import */ var _src_Models_Debug_Phase_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
        /* harmony import */ var _src_Models_Debug_DebugEvents_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
        /* harmony import */ var _src_Models_Debug_PhaseTypes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
        ...
        function spawnLegacyHelpButton(address) {
          ...
          twcheese_menu.onmouseover = function () {
            this.style.background = `url("${ImageSrc["a" /* ImageSrc */].legacy.helpBackgroundBright}")`
          };
          twcheese_menu.onmouseout = function () {
            this.style.background = `url("${ImageSrc["a" /* ImageSrc */].legacy.helpBackground}")`
          };
        ...
        class DebuggerWidget_DebuggerWidget extends AbstractWidget["a" /* AbstractWidget */] {
          ...
          renderCurrentPhase() {
            ...
            switch (phase.getType()) {
              case PhaseTypes["a" /* PhaseTypes */].QUESTION:
                this._renderPhaseQuestion(phase);
                break;
              case PhaseTypes["a" /* PhaseTypes */].ATTEMPT:
                this._renderPhaseAttempt(phase);
                break;
              case PhaseTypes["a" /* PhaseTypes */].REPORT:
